...
void COutlookAPI::runRulesOnSPAM()
{
    if ( !fRules )
        return;
    ...
    auto junkFolder = reinterpret_cast< Outlook::MAPIFolder * >( fJunkFolder.get() );
    auto junkFolderTypeID = qRegisterMetaType< Outlook::MAPIFolder * >( "MAPIFolder*", &junkFolder );
